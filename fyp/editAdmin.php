...
Program Name:editAdmin.php
Description: UI design table for editting admin information
...
<div id="container">
 ...
 <form name="update" action="adminValidation.php" method="POST">
<input type="hidden" name="no" value="<?php echo $no; ?>">
  ...
  <div class="userinput">
   ...
   <td><input type="text" name="Full_Name" required= "required"></td>
  </div>
